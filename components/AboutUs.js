    ...
    <section className={styles["about-us-container"]}>
      ...
      <section className={styles["paragraph-container"]}>
        <p className={styles.paragraph}>
          ...
          and construction techniques. We embraced the rich cultural heritage
          and diverse architectural landscapes of Bandung, which served as an
          endless source of inspiration for our future endeavours.
        </p>
      </section>
      <section className={styles["paragraph-container"]}>
        <p className={styles.paragraph}>
          Throughout our architectural journey, we have had the privilege of
          welcoming another brilliant mind into our team. Valencia is a talented
          female architect who brings her unique perspective, creativity, and
          keen eye for aesthetics that have enriched our collective approach to
          design.
        </p>
      </section>
      <section
      ...
      >
        <p className={styles.paragraph}>
          ...
          growth. We embrace ongoing professional development, staying informed
          about emerging trends, technological advancements, and design
          philosophies. This enables us to infuse our projects with the latest
          innovations and design approaches while maintaining a deep respect for
